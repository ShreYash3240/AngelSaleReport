...
function showDigitalReceiptSlip(bill) {
    ...
    slipArea.innerHTML = `
        <div class="receipt-border-box" style="border: 2px solid #000; border-radius: 8px; padding: 10px 8px 8px 8px; font-family: 'Arial', sans-serif; color: #000; background: #fff; font-size: 0.72rem; box-sizing: border-box; width: 100%; max-width: 1280px; margin: 0 auto;">
