        ...
        if (i < items.length) {
            ...
            rowsHtml += `
                <tr style="height: 22px;">
                    <td style="width: 20%; border-right: 1.2px solid #000; border-bottom: 1px solid #cbd5e1; text-align: center; font-size: 0.68rem; padding: 3px 2px; vertical-align: middle; box-sizing: border-box;">${i + 1}</td>
                    <td style="width: 30%; border-right: 1.2px solid #000; border-bottom: 1px solid #cbd5e1; padding: 3px 4px; font-weight: 600; font-size: 0.68rem; word-break: break-word; white-space: normal; line-height: 1.1; vertical-align: middle; box-sizing: border-box;">${item.name}${sizeStr}</td>
                    <td style="width: 25%; border-right: 1.2px solid #000; border-bottom: 1px solid #cbd5e1; text-align: center; font-size: 0.7rem; padding: 3px 2px; vertical-align: middle; box-sizing: border-box;">${item.quantity || 1}</td>
            ...
            rowsHtml += `
                <tr style="height: 22px;">
                    <td style="width: 20%; border-right: 1.2px solid #000; border-bottom: 1px solid #cbd5e1; box-sizing: border-box;"></td>
                    <td style="width: 30%; border-right: 1.2px solid #000; border-bottom: 1px solid #cbd5e1; box-sizing: border-box;"></td>
                    <td style="width: 25%; border-right: 1.2px solid #000; border-bottom: 1px solid #cbd5e1; box-sizing: border-box;"></td>
            ...
            <table style="width: 100%; table-layout: fixed; border-collapse: collapse; border: 1.2px solid #000; font-size: 0.72rem; box-sizing: border-box; margin: 0 auto;">
                <thead>
                    <tr style="border-bottom: 1.2px solid #000;">
                        <th style="width: 20%; border-right: 1.2px solid #000; padding: 3px 2px; text-align: center; font-weight: bold; box-sizing: border-box;">SR.</th>
                        <th style="width: 30%; border-right: 1.2px solid #000; padding: 3px 4px; text-align: left; font-weight: bold; box-sizing: border-box;">PARTICULARS</th>
                        <th style="width: 25%; border-right: 1.2px solid #000; padding: 3px 2px; text-align: center; font-weight: bold; box-sizing: border-box;">QTY</th>
